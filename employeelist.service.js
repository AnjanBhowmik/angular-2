...
var EmployeelistService = (function () {
    function EmployeelistService(http) {
        this.http = http;
        this.jsonUrl = 'app/json/empData.json';
    }
    EmployeelistService.prototype.getEmpData = function () {
        return this.http.get(this.jsonUrl)
            .map(function (res) { return res.json(); });
    };
    EmployeelistService.prototype.extractData = function (res) {
        var body = res.json();
        return body.data || {};
    };
...
exports.EmployeelistService = EmployeelistService; //eof class EmployeeService{}
